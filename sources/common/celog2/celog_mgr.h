...
#pragma once
#ifndef __COMMON_CELOG2_CELOG_MGR_H__
#define __COMMON_CELOG2_CELOG_MGR_H__
...
private:
  atomic<unsigned int> initRefCount_;
  nlthread_mutex_t logMutex_;
  FILE *logFile_;
  wstring logFileBasePath_; // base path of the log file (without the index)
  wstring logDirPath_;      // path of the log file directory
...
#endif /* __COMMON_CELOG2_CELOG_MGR_H__ */
